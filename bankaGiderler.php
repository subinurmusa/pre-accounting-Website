...
<div class=" d-flex justify-content-end ">
    ...
    <div class=" container d-flex align-items-center w-50 justify-content-start mt-5 ">
        <p class="text-primary d-flex align-items-center gap-2 fs-3 mt-5 text-dark">  <i class="fa-solid fa-file-invoice-dollar"></i> Banka Gideri</p>
    </div>
    <hr>
    <div class="">
    <div class="container">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="duzenleme_tarihi" name="duzenleme_tarihi" value="<?php echo date("d.m.Y") ?>" data-date-format="dd.mm.yyyy" autocomplete="off">
                            </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="number" id="toplam_tutar" name="toplam_tutar" placeholder="0.00" step="0.01" inputmode="numeric">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="vade_tarihi" name="vade_tarihi" value="<?php echo date("d.m.Y") ?>" data-date-format="dd.mm.yyyy" autocomplete="off">
                            </div>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    $(function () {
        ...
        $("#duzenleme_tarihi").datepicker($.datepicker.regional["tr"]);
