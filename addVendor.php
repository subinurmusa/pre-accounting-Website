            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="FaxNum" name="FaxNum">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="ibanNum" name="ibanNum">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="postakodu" name="postakodu">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <textarea  class="form-control"  id="notes" name="notes"cols="5" rows="5"></textarea>
                    </div>
                </div>
            </div>
        </div>
