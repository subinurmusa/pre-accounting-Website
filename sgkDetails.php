...
<div class=" d-flex justify-content-end ">
    ...
    <div class=" container d-flex align-items-center w-50 justify-content-start mt-5 ">
        <p class="text-primary d-flex align-items-center gap-2 fs-3 mt-5 text-dark">   Vergi / SGK Primi Düzenle</p>
    </div>
    <hr>
    <div class="">
    <div class="container">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="<?php echo $sgklist["title"]; ?>" id="kayitIsmi" name="kayitIsmi">
                            </div>
                        </div>
    ...
    <option value="Ocak" <?php echo $sgklist["vergiDonemiMonth"]=="Ocak"?"selected":"" ?>>Ocak</option>
    <option value="Şubat" <?php echo $sgklist["vergiDonemiMonth"]=="Şubat"?"selected":"" ?>>Şubat</option>
    <option value="Mart" <?php echo $sgklist["vergiDonemiMonth"]=="Mart"?"selected":"" ?>>Mart</option>
    <option value="Nisan" <?php echo $sgklist["vergiDonemiMonth"]=="Nisan"?"selected":"" ?>>Nisan</option>
    <option value="Mayıs" <?php echo $sgklist["vergiDonemiMonth"]=="Mayıs"?"selected":"" ?>>Mayıs</option>
    <option value="Haziran" <?php echo $sgklist["vergiDonemiMonth"]=="Haziran"?"selected":"" ?>>Haziran</option>
    <option value="Temmuz" <?php echo $sgklist["vergiDonemiMonth"]=="Temmuz"?"selected":"" ?>>Temmuz</option>
    <option value="Ağustos" <?php echo $sgklist["vergiDonemiMonth"]=="Ağustos"?"selected":"" ?>>Ağustos</option>
    <option value="Eylül" <?php echo $sgklist["vergiDonemiMonth"]=="Eylül"?"selected":"" ?>>Eylül</option>
    <option value="Ekim" <?php echo $sgklist["vergiDonemiMonth"]=="Ekim"?"selected":"" ?>>Ekim</option>
    <option value="Kasım" <?php echo $sgklist["vergiDonemiMonth"]=="Kasım"?"selected":"" ?>>Kasım</option>
    <option value="Aralık" <?php echo $sgklist["vergiDonemiMonth"]=="Aralık"?"selected":"" ?>>Aralık</option>
                                ...
                                <select class="form-select" id="vergi_yil" name="vergi_yil">
                                    <?php $time= date("Y");
                                          for ($i=$time+4 ; $i >= $time-4; $i--) { 
                                            # code...
                                      ?>
                                            <option value="<?php echo $i ?>" <?php echo $i== $sgklist["vergiDonemiYear"]? "selected":""; ?>><?php echo $i ?></option>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="number" id="toplam_tutar" name="toplam_tutar" value="<?php echo $sgklist["totalCost"]; ?>" step="0.01" inputmode="numeric">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="<?php echo $sgklist["dueDate"]; ?>" id="vade_tarihi" name="vade_tarihi" placeholder="Ödemenin vadesi" data-date-format="dd.mm.yyyy" autocomplete="off">
                            </div>
                        </div>
                    </div>
