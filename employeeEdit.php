                    ...
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-regular fa-user fs-5"></i>
                            <label for="nameSurname" class="form-label w-25  me-5 pe-4 ps-4">Çalışan adı ve soyadı </label>
                             ...
                             <input class="form-control" type="text" id="nameSurname" value="<?php echo $employeesInfo["nameSurname"]?>"name="nameSurname">
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-solid fa-id-card fs-5"></i>
                            ...
                            <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                             <input class="form-control" type="text" value="<?php echo $employeesInfo["TCno"]?>" id="tc" name="tc">
                ...
                <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-solid fa-hashtag fs-5"></i>
                            ...
                            <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                             <input class="form-control" value="<?php echo $employeesInfo["ibanNumber"]?>"type="text" id="iban" name="iban">
                ...
                <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-regular fa-envelope fs-5"></i>
                            ...
                            <input class="form-control"value="<?php echo $employeesInfo["Email"]?>" type="email" id="email" name="email">
                ...
                <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-solid fa-briefcase fs-5"></i>
                            ...
                            <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                             <input class="form-control" type="text" value="<?php echo $employeesInfo["position"]?>"id="pozisyon" name="pozisyon">
                ...
                <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                    <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                        ...
                        <i class="fa-solid fa-phone fs-5"></i>
                            ...
                            <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                             <input class="form-control" type="text" value="<?php echo $employeesInfo["phoneNumber"]?>" id="phonenumber" name="phonenumber">  </input>
