        ...
        <div class="div">
            ...
            <div class="div d-flex ps-5 mt-3 gap-5 align-items-center" style="position:relative; height:40px;">
                <div class="div text-black fs-3" style="position:absolute;left:280px;"> <span> <i
                            class="fa-solid fa-landmark fs-3"></i> Firma Bilgileri </span> </div>
                                    ...
                                    <nav class="navbar navbar-light p-4 bg-light w-100">
                                        <div
                                            ...
                                            <div class="d-flex justify-content-start align-items-center gap-3">
                                                ...
                                                <div class="fs-5 bold "> firma ismi </div>
                                            </div>



                                            <div>
                                                <a href="addFirmaInfo.php" class="btn btn-outline-primary text-dark">
                                                    Bilgileri Düzenle</a>
                                            </div>
    ...
    <div class="card-body shadow d-flex justify-content-start gap-5">
        ...
        <div>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><i class="fa-regular fa-building fs-5"></i></div>
                <div class="fw-bold">TİCARİ UNVAN</div>
            </div>
            <?php echo !empty($firmainfo["logo"]) ? '<div class="d-flex gap-5 mb-5 justify-content-start align-items-center">
                <div><i class="fa-regular fa-building fs-5"></i></div>
                <div class="fw-bold">FİRMA LOGO</div>
            </div> ' : ""; ?>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><i class="fa-regular fa-file-lines fs-5"></i></div>
                <div class="fw-bold">EVRAK TÜRÜ</div>
            </div>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><i class="fa-solid fa-circle-dot fs-5"></i></div>
                <div class="fw-bold">SEKTÖR</div>
            </div>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><i class="fa-solid fa-location-dot fs-5"></i></div>
                <div class="fw-bold">AÇIK ADRESİ</div>
            </div>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><i class="fa-solid fa-gavel fs-5"></i></div>
                <div class="fw-bold">VERGİ BİLGİLERİ</div>
            </div>
        </div>
        <!-- Right side -->
        <div>
            <div class="d-flex gap-5 mb-4 justify-content-start align-items-center">
                <div><?php echo !empty($firmainfo["ticariUnvan"]) ? $firmainfo["ticariUnvan"] : "----------"; ?></div>
            </div>
            <?php echo !empty($firmainfo["logo"]) ? '<div class="d-flex gap-5 mb-4 justify-content-start align-items-center">
                <div>
                    <img id="logoPreview" src="'.$firmainfo["logo"].'"
                        alt="" class="me-2 pb-0"
            ...
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><?php echo isset($firmainfo["sektor"]) ? $firmainfo["sektor"] : "------------"; ?></div>
            </div>
            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
    <div>
        <?php echo isset($firmainfo["address"]) ? (!empty($firmainfo["address"]) ? $firmainfo["address"] : "---------") : "----------"; ?>
    </div>
</div>

            <div class="d-flex gap-5 mb-3 justify-content-start align-items-center">
                <div><?php echo !empty($firmainfo["vergiDairesi"]) ? ($firmainfo["vergiNum"] == null ? "<b>V.D</b> " . $firmainfo["vergiDairesi"] : "<b>V.D</b> " . $firmainfo["vergiDairesi"] . " <b>V.N</b> " . $firmainfo["vergiNum"]) : "----------"; ?>
                </div>
            </div>
        </div>
    </div>
