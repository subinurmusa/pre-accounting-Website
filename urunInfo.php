...
<body>
    ...
    <div class=" container d-flex align-items-center w-50 justify-content-start mt-5 ">
        <p class="text-primary d-flex align-items-center gap-2 fs-3 mt-5 text-dark"> <i class="fa-solid fa-circle-info fs-3"></i> Ürün Bilgilerini Görüntüle</p>
    </div>
    <hr>
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-tag fs-5"></i>
                                ...
                                <input class="form-control" type="text" id="urunname" name="urunname" disabled value="<?php echo $products["productname"]?>">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-calendar-plus fs-5"></i>
                                ...
                                <input class="form-control" type="text" id="addedDate" disabled value="<?php echo $products["date-added"]?>" name="addedDate">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-coins fs-5"></i>
                                ...
                                <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                                <input class="form-control" type="text" id="price" disabled value="<?php echo $products["price"]?>" name="price">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fa-solid fa-barcode fs-5"></i>
                                ...
                                <input class="form-control" type="text" id="barkod" disabled value="<?php echo $products["barkodnumara"]?>" name="barkod">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-balance-scale fs-5"></i>
                                ...
                                <!-- <input type="text" id="costomer" name="musteri" class="form-control w-100 ms-5 ps-5"> -->
                                <select class="form-select" type="text" id="birim" disabled name="birim">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-cubes fs-5"></i>
                                ...
                                <input class="form-control" type="number" disabled id="StokMiktar" value="<?php echo $products["stokmiktari"]?>" name="StokMiktar">
                    ...
                    <div class="col-md-9  d-flex justify-content-around align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                            ...
                            <i class="fas fa-shopping-basket fs-5"></i>
                                ...
                                <input class="form-control" type="number" disabled id="SellMiktar" value="<?php echo $products["miktar"]?>" name="SellMiktar">
                ...
                <div class="row  d-flex justify-content-end align-items-center mt-3 ">
                    <div class="col-md-9  d-flex  align-items-center  me-5 pe-5">
                        <div class="d-flex align-items-center justify-content-end w-100 ms-4">
                            <div class="bottons">
                                <a href="urunvehizmet.php" class="btn btn-secondary  d-flex align-items-center"> <i class="fa-solid fa-arrow-left fs-5 me-2"></i> <span> Geri Dön</span></a>
