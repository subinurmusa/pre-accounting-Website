            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="vendorName" value="<?php echo $vendorlist["vendorName"]; ?>" name="vendorName">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="category"  value="<?php echo $vendorlist["category"]==null?"":$vendorlist["vendorName"]; ?>" name="category">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="email" id="email" value="<?php echo $vendorlist["email"]==null?"":$vendorlist["email"]; ?>" name="email">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="phoneNum" value="<?php echo $vendorlist["phoneNum"]==null?"":$vendorlist["phoneNum"]; ?>" name="phoneNum">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="FaxNum" value="<?php echo $vendorlist["FaxNum"]==null?"":$vendorlist["FaxNum"]; ?>" name="FaxNum">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="ibanNum" value="<?php echo $vendorlist["ibanNum"]==null?"":$vendorlist["ibanNum"]; ?>" name="ibanNum">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-start justify-content-center w-100 gap-4">
                        ...
                        <label for="address" class="form-label w-25 me-5 pe-4 ps-4">Açık Adres</label>
                            ...
                            <textarea class="form-control" id="address"  name="address" cols="5" rows="5"><?php echo $vendorlist["address"]==null?"":$vendorlist["address"]; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="postakodu" value="<?php echo $vendorlist["postakodu"]==null?"":$vendorlist["postakodu"]; ?>" name="postakodu">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <textarea  class="form-control"  id="notes" name="notes"cols="5" rows="5"><?php echo $vendorlist["notes"]==null?"":$vendorlist["notes"]; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9 d-flex justify-content-around align-items-center me-5 pe-5">
                <div class="d-flex align-items-center justify-content-between w-100 ms-4">
                    <div class="d-flex align-items-center justify-content-center w-100 gap-4">
                        ...
                        <input class="form-control" type="text" id="VKNorTCKN" value="<?php echo $vendorlist["TCKNorVKN"]==null?"":$vendorlist["TCKNorVKN"]; ?>" name="VKNorTCKN">
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
    $('#submit').click(function(e){
        ...
        // Send AJAX request
        $.ajax({
            url: 'vendoreditfile.php',
            type: 'POST',
            data: formData,
            success: function(response){
                $('#errorDiv').html(response); // Display response in errorDiv
            }
        });
    });
});
