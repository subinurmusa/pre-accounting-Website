...
<body>
    ...
    <div class="">
        <div class="div">
            ...
            <div class="div d-flex ps-5 mt-3 gap-5 align-items-center"
                ...
                <div class="div text-black fs-3" style="position:absolute;left:280px;"> <span><i class="fa-solid fa-users-line fs-3"></i> Tedarikçi Listesi </span> </div>
    ...
    <select class="form-select w-75 me-1" name="category">
        <option value="vendorname">Tedarikçi Adı</option>
    ...
    <button class="btn btn-outline-success rounded-pill text-dark" type="submit">Ara</button>
                                            ...
                                            <div>
                                                <a href="addVendor.php" class="btn btn-outline-success text-dark"> Yeni Çalışan Ekle</a>
                                            </div>
                                        </div>
                                    </nav>
                                </div>
                                               ...
                                               while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { 
                                                ...
                                                ?>  
                                                      ...
                                                      <div class="d-flex align-items-center gap-3">
                                                       <a href="vendorEdit.php? id=<?php  echo $row["id"] ;?>" ><i class="fa-regular fa-pen-to-square fs-3 text-success"></i></a>
                                                       <a href="vendorInfo.php? id=<?php  echo $row["id"] ;?>"> <i class="fa-solid fa-circle-info fs-3 detay text-primary"> </i> </a>
