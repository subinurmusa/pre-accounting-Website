...
<div  class="d-flex flex-column flex-shrink-0 p-3 text-white bg-black bg-opacity-75" style="height: 100vh; width: 200px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="dashbaordPage.php" class="nav-link text-white d-flex gap-3 align-items-center">
                <i class="fa-solid fa-house-user me-2 "></i> Ana Sayfa
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white d-flex gap-3 align-items-center" data-bs-toggle="collapse" data-bs-target="#home-collapse2">
            <i class="fa-solid fa-arrow-down-short-wide text-white"></i> Satışlar
            </a>
            <div class="collapse" id="home-collapse2">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link text-white">Satış Raporu</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex gap-3 align-items-center" data-bs-toggle="collapse" data-bs-target="#home-collapse3">
            <i class="fa-solid fa-arrow-up-from-bracket text-white"></i>  Giderler
            </a>
            <div class="collapse" id="home-collapse3">
                <ul class="nav flex-column">
                    <li class="nav-item"><a href="satislar.php" class="nav-link text-white">GiderListesi</a></li>
                    <li class="nav-item"><a href="#" class="nav-link text-white">Tedarikçiler</a></li>
                    <li class="nav-item"><a href="musteriler.php" class="nav-link text-white">Çalışanlar</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex gap-3 align-items-center" data-bs-toggle="collapse" data-bs-target="#home-collapse4">
            <i class="fa-regular fa-money-bill-1 text-white"></i> Nakit
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex gap-3 align-items-center" data-bs-toggle="collapse" data-bs-target="#home-collapse5">
            <i class="fa-solid fa-cubes text-white"></i> Stok
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex gap-3 align-items-center" data-bs-toggle="collapse" data-bs-target="#home-collapse6">
            <i class="fa-solid fa-gears text-white"></i> Ayarlar
            </a>
